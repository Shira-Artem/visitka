...
Production URL: [http://127.0.0.1:4181/index.html?v=20260821-12](http://127.0.0.1:4181/index.html?v=20260821-12)
...
- Hero оставляет один главный product screen — клиентское меню; рядом стоит читаемая карточка
...
- Sync section уплотнён под showcase-референс: компактный заголовок и chips сверху,
  один общий board с телефонами «директор → гость» и центральной стрелкой синхронизации.
- Светлые desktop-секции собраны на едином тёплом фоне `--dl-paper-2`; белые boards/cards
  отделены общей линией, радиусом и тенью. CTA стал глубже по тону, footer сохранил тёмный контраст.
