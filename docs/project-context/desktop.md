...
- Hero оставляет один главный product screen — клиентское меню; рядом стоит читаемая team-панель
  «один бот · четыре роли», а директорский dashboard раскрывается ниже, где он не теряет масштаб.
